...
$lapClaim = "SELECT no_urut, dealer, daerah, tglNota, toko, b.brg, k.kat, pattern, dot, kerusakan, tread, keputusan, nominal, tahun, noCM, tglCM
FROM(
SELECT no_urut, dealer, daerah, tglNota, toko, brg, pattern, dot, kerusakan, tread, keputusan, nominal, tahun, noCM, tglCM
FROM tblNota
	...
	foreach ($array as $index => $val) {
        if ($index==0) 
        {
         	echo '
	         		<tr>
	         			<tr>
	         				<td id="kat" colspan="12" id="kategori">'.$val['kat'].'</td>
	         			</tr>';
	    } 
			echo '
