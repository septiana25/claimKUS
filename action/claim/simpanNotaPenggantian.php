...
if ($_POST) {
	...
	$dateArr[2] = '1';
	$newDate 	= strtotime(implode($dateArr, '-'));
	...
	$register  = $koneksi->real_escape_string($_POST['register']);
	$noReg     = $koneksi->real_escape_string($_POST['noReg']);
	$noRegister= $register.$noReg;
