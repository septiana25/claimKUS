<?php
      ...
      $bulan          = date("m");
      //$bulan1          = 7;
// $cek_saldo = $koneksi->query("SELECT id_saldo FROM saldo WHERE MONTH(tgl)=$bulan AND YEAR(tgl)=$jenis_claim");
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                      ...
                      <table class="table">
                          ...
                          <tr>
                            <th >Tanggal</th>
                            <!-- <th >No REG Claim KUS</th> -->
                            <th >No Urut</th>
                            <th >Daerah</th>
                            <th >Tempat Pemeriksaan</th>
                          </tr>
                         <?php
                        $getNo = "SELECT no_urut FROM claim ORDER BY id_claim DESC LIMIT 0,1";
                        $resNo = $koneksi->query($getNo);
                        $rowNO =$resNo->fetch_assoc();
                        $no = substr($rowNO['no_urut'], 4);
                        $noNext = $no+1;
                        $thn = substr(date('Y'), 2);
                        $pjnNo = strlen($noNext);
                        $bulanDB = substr($rowNO['no_urut'], 0,2);
                        $bulan = date('m');
                        if ($bulanDB == $bulan) {
                          ...
                          $noUrut = $bulan.$thn.$NoAwal.$noNext;

                        }else{
                          $noUrut = $bulan.$thn.'001';
                        }
...
<!--                             <td>
                              <input id="no_reg" name="no_reg" type="text" class="input-small" minlength="8" maxlength="8" placeholder="Input No REG" />
                            </td> -->

                            <td>                              
                              <input id="no_urut" name="no_urut" type="text" class="input-small" value="<?php echo $noUrut; ?>" readonly="true"/>
                              <!-- <p class="help-block catatan">*Bulan jenis_claim No</p> -->
                            </td>
                            ...
                            <td>
                                <input id="dealer" name="dealer" type="text" class="input-small" value="KUS" readonly="true" />   
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <input id="no_claim" name="no_claim" type="text" class="input-small"  placeholder="Input No Claim" />
                            </td>
                            ...
                            <td>
                              <input onkeydown="upperCaseF(this)" id="areaToko" name="areaToko" type="text" class="input-xlarge" placeholder="Input Area Toko" autocomplete="off" />
                            </td>
                            <td>
                      ...
                      <table class="table">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <input onkeydown="upperCaseF(this)" id="jenis_claim" name="jenis_claim" type="text" class="input-medium" placeholder="Jenis Claim" autocomplete="off" />
                              </td>
                            </tr>
                          </tbody>
                      </table>
...
<!--                       <table class="table">
                      ...
                      <div class="form-actions">
                          <button type="submit" class="btn btn-success" id="simpanClaim"><i class="fa fa-save"></i> Simpan</button>
