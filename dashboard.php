...
if ($cek_saldo->num_rows >=1 ) {
    ...
    require_once 'include/menu.php';
      ...
      $query_brg = $koneksi->query("SELECT msk.id_brg, IFNULL(total_msk, 0) - IFNULL(total_klr, 0) AS total_stok
                                    FROM( 
      ...
      $query_kat = $koneksi->query("SELECT COUNT(*) FROM kat");
      $row_kat = $query_kat->fetch_array();
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-light-blue">
                        <a data-original-title="" href="#">
                            ...
                            <div class="info"><?php echo $row_brg[1]; ?></div>
                            <div class="status">Stock Barang</div>
                        </a>
                    </div>
                    ...
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="" href="#">
                            ...
                            <div class="info"><?php echo $row_kat[0]; ?></div>
                            <div class="status">Kategori</div>
                        </a>
                    </div>
