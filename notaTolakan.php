         ...
         <div class="container-fluid">
            ...
            <!-- BEGIN MODAL MASUK-->
              <div id="modalVIewData" class="modal modal-form-tinggi hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                  ...
                  <form class="cmxform form-horizontal" id="submitPrintNota" action="action/claim/printNota.php" method="POST" >
                            ...
                            <table width="100%" role="none">
                              <tr>
                                ...
                                <td>
                                  ...
                                  <input id="idNota" name="idNota" type="hidden" readonly="true" />
                                </td>
                              </tr>
                            </table>
                          </div>
                      ...
                      <div class="modal-footer">
                          <button class="btn btn-primary hidden" id="printNotaBtn" type="submit" data-loading-text="Loading..." autocomplete="off" ><i class="fa fa-print"></i> Print</button>
